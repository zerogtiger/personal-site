...
export default function FootNav() {
  return (
    <footer className="-border mx-auto px-2 max-w-[53rem] mt-40 mb-10 z-20">
      <div className="flex border-[1px] border-bg2 rounded-[0.5rem] justify-center px-4 py-4">
        ...
        <div className='-border w-full sm:w-3/4 h-fit grid grid-cols-2 grid-flow-row gap-4'>
          <Link href={"/"}>
            <div className="text-center sm:text-left group border-[1px] h-full border-bg4 text-blue hover:border-orange rounded-[0.5rem] px-4 py-4 space-y-2">
