...
const supabaseUrl = "https://cxjhsfidhhiosbzkofzs.supabase.co";
...
export async function GET(
  ...
  let { data, error } = await supabase.from('photos').select("*, cameras:camera_id ( * ), locations:location_id ( * ), lenses:lens_id ( * )");
